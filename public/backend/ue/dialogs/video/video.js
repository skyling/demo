...
(function(){
    ...
    UploadFile.prototype = {
        ...
        initUploader: function () {
            ...
            // WebUploader实例
                uploader,
                actionUrl = editor.getOpt('qiniuUploadUrl') || editor.getActionUrl(editor.getOpt('videoActionName')),
            ...
            uploader = _this.uploader = WebUploader.create({
                ...
                server: actionUrl,
                fileVal: editor.getOpt('qiniuUploadUrl') ? 'file' : editor.getOpt('videoFieldName'),
                duplicate: true,
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    if (json.state == 'SUCCESS' || (editor.getOpt('qiniuUploadUrl') && !!json.key)) {
                        json.url = json.key ? (editor.getOpt("qiniuUrlPrefix") + json.key) : json.url;
